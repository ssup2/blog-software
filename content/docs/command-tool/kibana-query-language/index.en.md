...
* `[Field]:[Value]` : Get only documents where value exists in field
  * `response:200` : Get only documents where value `200` exists in `response` field
...
* `not [Field]:[Value]` : Get only documents where value does not exist in field
  * `not response:200` : Get only documents where value `200` does not exist in `response` field
* `[Field1]:[Value1] and [Field2]:[Value2]` : Get only documents where value1 exists in field1 and value2 exists in field2
  * `response:200 and message:"ssup2"` : Get only documents where value `200` exists in `response` field and string value `ssup2` exists in `message` field
...
* `[Field]:*` : Get only documents where field exists
  * `response:*` : Get only documents where `response` field exists
