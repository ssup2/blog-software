...
**Cloud-Native**는 **Cloud 환경의 이점을 최대한 활용하여 App을 개발하고, App을 구동하는 접근법**을 의미한다. 여기서 말하는 Cloud 환경의 이점은 확장성과 유연성이다. IaaS를 통해 Compute, Network, Storage 자원을 필요에 따라서 쉽게 할당받고 이용 할 수 있다. Container 기술을 통해 App은 App마다 독립된 환경을 유지하면서도 각 Compute 자원에 빠르게 배포될 수 있게 되었다.
