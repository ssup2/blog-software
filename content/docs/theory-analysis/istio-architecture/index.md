...
* **Galley** : Control Plan의 나머지 구성요소들을 설정하고 관리하는 역할을 수행한다.
...
Istio는 v1.5 Version 이후부터 Architecture가 변경되었다. [Figure 2]는 v1.5 Version 이후의 Istio Architecture를 나타내고 있다. Pilot, Galley, Citadel이 **Istiod**라고 불리는 하나의 Component(Binary)로 통합되었고, **Mixer**는 Deprecated 되었다.
