...
**MapReduce**는 대용량의 Data를 분산 처리하는 기법이다. [Figure 1]는 MapReduce 과정을 나타내고 있다. Hadoop에서 가장 먼저 지원하기 시작했으며 현재는 CouchDB, MongoDB 같은 Document Type의 NoSQL DB에서도 지원하고 있다. MapReduce는 크게 Splitting, Mapping, Shuffling, Reducing 4가지 과정으로 진행된다.
