...
{{< figure caption="[Figure 1] Project 생성" src="images/google-create-project.png" width="600px" >}}

[Figure 1]과 같이 [https://console.developers.google.com](https://console.developers.google.com/)에 접근하여 Project를 생성한다.

{{< figure caption="[Figure 2] OAuth 추가" src="images/google-create-oidc-1.png" width="900px" >}}
...
{
	"OAuth2Token": {
		"access_token": "ya29.A0ARrdaM-Y-JCmxefKPNfi8Q26hzrCu1nDKiV-UYKAjDud-N3MnksWdxS3SlfyTUwi9IB1z-N2KyZRTgBS-BdEXXrLKQi3ZQMrDvZOAx2dwXvkknN7dJS6HM1-gpB7JMHk2SzRTi23eldSqjEG8P4NueCamROX-w",
		"token_type": "Bearer",
