---
title: Kubernetes Kubeflow Installation / Using kind / Ubuntu 20.04 Environment
---
...
Install kind to create a Kubernetes cluster.

## 3. Kustomize Installation

```shell
$ wget https://github.com/kubernetes-sigs/kustomize/releases/download/v3.2.0/kustomize-3.2.0-linux-amd64 -O /usr/bin/kustomize
```

Install Kustomize for Kubeflow installation.
...
Configure a single Master Node cluster with one control-plane using kind.
...
## 6. Kubeflow Dashboard Access

```shell
$ kubectl port-forward svc/istio-ingressgateway -n istio-system 8080:80
```

Execute kubectl port-forward and access the following path.
