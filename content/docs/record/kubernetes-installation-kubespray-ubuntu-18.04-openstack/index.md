...
Deploy Node의 `inventory/mycluster/group_vars/k8s-cluster/k8s-cluster.yml` 파일에 CNI Plugin으로 `cilium`을 이용하도록 설정하고, Persistent Volume을 Enable 설정하여 Kubernetes가 OpenStack의 Cinder를 이용하도록 설정한다.
